...
class BetterFramework_Oculus_Message_Manager {
	...
	public static function init() {
		...
		add_action( 'better-framework/oculus/check-update/done', array( __CLASS__, 'save_messages' ) );
		add_filter( 'better-framework/oculus/check-update/data', array( __CLASS__, 'check_data' ) );
	}
