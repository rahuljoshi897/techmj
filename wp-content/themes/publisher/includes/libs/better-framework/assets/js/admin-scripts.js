        ...
        setup_panel_tabs: function(){
            ...
            $('#bf-nav').find('a').click( function(e){
                ...
                function initShowOn() {
                    ...
                    if(! _this.data('show-on-triggered')) {

                        self.setup_interactive_fields_for_bf(_target);
                        _this.data('show-on-triggered',true);
                    }
                }
            ...
            function getData() {
                ...
                for (var id in opts) {
                    ...
                    if (typeof obj.cat !== "undefined") {
                        cats[ obj.cat ] = modal_loc.categories[ obj.cat ] || obj.cat;
                    }

                    if (typeof obj.type !== "undefined") {
                        types[ obj.type ] = modal_loc.types[ obj.type ] || obj.type;
                    }
                    ...
                    $.bs_selector_modal({
                        ...
                        events: {
                            ...
                            after_append_html: function () {
                                ...
                                modal.bsModal.$modal.on('click', '.bf-toggle-item-status a:not(.disabled)', function (e) {

                                    var $selectedItem = $(this).closest('.bssm-item'),
                                        selectedItemId  = $selectedItem.data('item-id'),
                                        selectedItemImg = $selectedItem.find('figure img').attr('src'),
