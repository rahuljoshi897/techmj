		...
		array(
			'selector' =>
				array(
					...
					// 14 reserved
					15 => '.section-heading.main-term-%%id%% .h-text.main-term-%%id%%',
					16 => '.section-heading .h-text.h-text.main-term-%%id%%:hover',
					17 => '.section-heading.multi-tab.main-term-%%id%% .active > .h-text.main-term-%%id%%',
					18 => '.section-heading .other-link:hover .h-text.main-term-%%id%%',
