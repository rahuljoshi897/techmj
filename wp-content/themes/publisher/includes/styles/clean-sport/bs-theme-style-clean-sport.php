...
class Publisher_Theme_Style_Clean_Sport extends Publisher_Theme_Style {
	...
	function include_functions() {
		if ( $this->style_id == Publisher_Theme_Styles_Manager::$current_style ) {
			include_once Publisher_Theme_Styles_Manager::get_path( 'clean-sport/functions.php' );
		}
	}
	...
	function customize_category_fields( $fields ) {
		...
		$term_css['bg_color']['selector'][] = '.section-heading.main-term-%%id%% .h-text.main-term-%%id%%';
		$term_css['bg_color']['selector'][] = '.section-heading.multi-tab.main-term-%%id%% .active > .h-text.main-term-%%id%%';
		$term_css['bg_color']['selector'][] = '.section-heading.main-term-%%id%% .h-text.main-term-%%id%%:hover';
		$term_css['bg_color']['selector'][] = '.section-heading.multi-tab.main-term-%%id%% .active > .h-text.main-term-%%id%%';
		$term_css['bg_color']['selector'][] = '.section-heading .other-link:hover .h-text.main-term-%%id%%';
