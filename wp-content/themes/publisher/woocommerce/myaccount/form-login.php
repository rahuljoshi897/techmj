...
<div class="u-columns col2-set" id="customer_login">
	...
	<div class="u-column1 col-1">
		...
		<form method="post" class="login">
			...
			<h2 class="section-heading"><span class="h-text"><?php esc_html_e( 'Login', 'woocommerce' ); ?></span>
			</h2>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<h2 class="section-heading"><span class="h-text"><?php esc_html_e( 'Register', 'woocommerce' ); ?></span>
			</h2>
