...
elseif ( function_exists( 'is_woocommerce' ) && is_woocommerce() ) {
	...
	if ( is_shop() ) {
		$menu_args['menu'] = bf_get_post_meta( 'main_nav_menu', wc_get_page_id( 'shop' ) );
	} elseif ( is_cart() ) {
		$menu_args['menu'] = bf_get_post_meta( 'main_nav_menu', wc_get_page_id( 'cart' ) );
	} elseif ( is_checkout() ) {
		$menu_args['menu'] = bf_get_post_meta( 'main_nav_menu', wc_get_page_id( 'checkout' ) );
	} elseif ( is_account_page() ) {
		$menu_args['menu'] = bf_get_post_meta( 'main_nav_menu', wc_get_page_id( 'myaccount' ) );
	} elseif ( is_product_category() || is_product_tag() ) {
		$menu_args['menu'] = bf_get_term_meta( 'main_nav_menu', get_queried_object()->term_id );
	}
