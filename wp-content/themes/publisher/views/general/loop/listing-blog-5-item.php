...
?>
	<article <?php publisher_attr( 'post', publisher_get_prop_class() . ' clearfix listing-item listing-item-blog  listing-item-blog-5 ' . $main_term_class ); ?>>
		...
		<?php if ( ! empty( $thumbnail['src'] ) ) { ?>
			<div class="featured clearfix">
				...
				<a <?php publisher_the_thumbnail_attr( $thumbnail_size ); ?>
					class="img-holder" href="<?php the_permalink(); ?>"></a>
				<?php
		...
		} else if ( publisher_get_prop( 'show-read-more', TRUE ) ) {
