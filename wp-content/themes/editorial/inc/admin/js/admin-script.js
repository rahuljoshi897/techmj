jQuery(document).ready(function($) {
    ...
    $('#customize-info .preview-notice').append(
        ...
        '<a class="editorial-pro-info" href="https://mysterythemes.com/wp-themes/editorial-pro/" target="_blank">View Pro</a>'+
        '<a class="editorial-pro-info" href="http://demo.mysterythemes.com/editorial-pro-landing/" target="_blank">View Pro Demos</a>'+
        '</div>'
    );
